...
rem
rem Copyright (C) 2006-9 IAIK, Graz University of Technology
rem
...
echo   - - - - -                - - - - -
echo               Test Suite
echo      (c) Copyright 2006-9, IAIK,   
echo     Graz University of Technology 
echo   ----------------------------------

java -cp %CLASSPATH% iaik.tc.tss.test.tsp.java.TestMain %*
