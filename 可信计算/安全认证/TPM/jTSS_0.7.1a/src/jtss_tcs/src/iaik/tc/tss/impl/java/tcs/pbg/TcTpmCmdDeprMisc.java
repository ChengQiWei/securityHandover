...
public class TcTpmCmdDeprMisc extends TcTpmCmdCommon {
	 ...
	 * @TPM_V2_R101 304
	 */
	public static Object[] TpmReset(TcIStreamDest dest) throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_Reset));
	 ...
	 *         <li> 2 ... The public endorsement key (TcTpmPubkey)
	 *         </ul>
	 * 
	 * @throws  TcTpmException This exception indicates that a TPM error has occurred. The specific
	 *           error code id held by the exception.
	 ...
	 * @TPM_V2_R101 305
	 */
	public static Object[] TpmOwnerReadPubek(TcIStreamDest dest, TcTcsAuth inAuth1)
		throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_AUTH1_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_OwnerReadPubek));
		...
		return new Object[] { outBlob.getRetCodeAsLong(), outAuth1, pubEndorsementKey };
	}
	 ...
	 * @TPM_V2_R101 306
	 */
	public static Object[] TpmDisablePubekRead(TcIStreamDest dest, TcTcsAuth inAuth1)
		throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_AUTH1_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_DisablePubekRead));
		inBlob.append(blobUINT32(inAuth1.getAuthHandle()));
		inBlob.append(inAuth1.getNonceOdd().getEncoded());
		inBlob.append(blobBOOL(inAuth1.getContAuthSession()));
		inBlob.append(inAuth1.getHmac().getEncoded());
	 ...
	 * @param inKey Incoming key structure, both encrypted private and clear publicportions. MAY be
	 *          TcTpmKey12
	 * 
	 * @return The returned Object[] holds the following elements:
	 *         <ul>
	 ...
	 * @TPM_V2_R101 307
	 */
	public static Object[] TpmLoadKey(TcIStreamDest dest, long parentHandle, TcTpmKey inKey,
			TcTcsAuth inAuth1) throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_AUTH1_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_LoadKey));
	 ...
	 * 
	 * @param dest The destination where the byte stream is written to.
	 * @param ordinalToQuery The ordinal whose audit flag is tobe queried
	 * 
	 * @return The returned Object[] holds the following elements:
	 *         <ul>
	 *         <li> 0 ... TPM return code (Long)
	 *         <li> 1 ... Value of audit flag for ordinalToQuery (boolean)
	 *         </ul>
	 * 
	 * @throws  TcTpmException This exception indicates that a TPM error has occurred. The specific
	 *           error code id held by the exception.
	 ...
	 * @TPM_V2_R101 313
	 */
	public static Object[] TpmGetOrdinalAuditStatus(TcIStreamDest dest, long ordinalToQuery)
		throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_GetOrdinalAuditStatus));
		inBlob.append(blobUINT32(ordinalToQuery));
		...
		// decode output values
		boolean State = outBlob.decodeBoolean();

		return new Object[] { outBlob.getRetCodeAsLong(), new Boolean(State) };
	}
}
