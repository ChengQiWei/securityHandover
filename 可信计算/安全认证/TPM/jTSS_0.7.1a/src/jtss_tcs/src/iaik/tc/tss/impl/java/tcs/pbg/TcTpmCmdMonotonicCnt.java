...
public class TcTpmCmdMonotonicCnt extends TcTpmCmdCommon {
	 ...
	 * @param encAuth The encrypted auth data for the new counter
	 ...
	 *         <li> 2 ... The handle for the counter (long)
	 *         <li> 3 ... The starting counter value (TcTpmCounterValue)
	 *         </ul>
	 * 
	 ...
	 * @TPM_V2_R101 247
	 */
	public static Object[] TpmCreateCounter(TcIStreamDest dest, TcTpmEncauth encAuth, TcBlobData label,
			TcTcsAuth inAuth1) throws TcTddlException, TcTpmException
	{
		...
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_CreateCounter));
		...
		long countID = outBlob.decodeUINT32();
		...
		return new Object[] { outBlob.getRetCodeAsLong(), outAuth1, new Long(countID), counterValue };
	}
	 ...
	 *         <li> 0 ... TPM return code (Long)
	 *         <li> 1 ... outgoing authorization for session containing new nonceEven (TcTpmAuth)
	 *         <li> 2 ... The counter value (TcTpmCounterValue)
	 *         </ul>
	 * 
	 * @throws  TcTpmException This exception indicates that a TPM error has occurred. The specific
	 *           error code id held by the exception.
	 ...
	 * @TPM_V2_R101 249
	 */
	public static Object[] TpmIncrementCounter(TcIStreamDest dest, long countID, TcTcsAuth inAuth1)
		throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_AUTH1_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_IncrementCounter));
		inBlob.append(blobUINT32(countID));
		inBlob.append(blobUINT32(inAuth1.getAuthHandle()));
		inBlob.append(inAuth1.getNonceOdd().getEncoded());
		inBlob.append(blobBOOL(inAuth1.getContAuthSession()));
		inBlob.append(inAuth1.getHmac().getEncoded());
		...
		// decode output values
		TcTpmCounterValue count = new TcTpmCounterValue(outBlob);
		...
		return new Object[] { outBlob.getRetCodeAsLong(), outAuth1, count };
	}
	 ...
	 * @TPM_V2_R101 251
	 */
	public static Object[] TpmReadCounter(TcIStreamDest dest, long countID) throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_ReadCounter));
		inBlob.append(blobUINT32(countID));
		...
		return new Object[] { outBlob.getRetCodeAsLong(), count };
	}
	 ...
	 * @TPM_V2_R101 252
	 */
	public static Object[] TpmReleaseCounter(TcIStreamDest dest, long countID, TcTcsAuth inAuth1)
		throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_AUTH1_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_ReleaseCounter));
		inBlob.append(blobUINT32(countID));
		inBlob.append(blobUINT32(inAuth1.getAuthHandle()));
		inBlob.append(inAuth1.getNonceOdd().getEncoded());
		inBlob.append(blobBOOL(inAuth1.getContAuthSession()));
	 ...
	 * @TPM_V2_R101 254
	 */
	public static Object[] TpmReleaseCounterOwner(TcIStreamDest dest, long countID, TcTcsAuth inAuth1)
		throws TcTddlException, TcTpmException
	{

		TcBlobData inBlob = blobUINT16(TcTpmConstants.TPM_TAG_RQU_AUTH1_COMMAND);
		inBlob.append(blobUINT32(0)); // paramSize is set later
		inBlob.append(blobUINT32(TcTpmOrdinals.TPM_ORD_ReleaseCounterOwner));
		inBlob.append(blobUINT32(countID));
		inBlob.append(blobUINT32(inAuth1.getAuthHandle()));
		inBlob.append(inAuth1.getNonceOdd().getEncoded());
		inBlob.append(blobBOOL(inAuth1.getContAuthSession()));
