...
public class TcTpmDaaBlob extends TcCompositeTypeDecoder {
	protected int tag_;
	...
	protected TcTpmDigest blobIntegrity_;
	...
	/*************************************************************************************************
	 * This method decodes the TPM_DAA_BLOB from the byte blob.
	 */
	protected void decode()
	{
		checkBoundaryPreconditions(2 + 4 + 16 + 20 + 4 + 4);

		tag_ = decodeUINT16();
		resourceType_ = decodeUINT32();
		label_ = decodeBytes(16);
		blobIntegrity_ = new TcTpmDigest(this);
		...
		if (sensitiveSize > 0) {
			sensitiveData_ = decodeBytes(sensitiveSize);
		}
	...
	public TcBlobData getEncoded()
	{
		...
		if (blobIntegrity_ != null) {
			retVal.append(blobIntegrity_.getEncoded());
		}
	...
	public String toString()
	{
		...
		retVal.append(Utils.getNL());
		if (label_ != null) {
			retVal.append("label  // 16 bytes: ");
			retVal.append(label_.toHexString());
			retVal.append(Utils.getNL());
		}
		if (blobIntegrity_ != null) {
			retVal.append("blobIntegrity: ");
			retVal.append(blobIntegrity_.toString());
			retVal.append(Utils.getNL());
		}
