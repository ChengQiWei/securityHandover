...
public class TcTpmDelegateSensitive extends TcCompositeTypeDecoder {
	protected int tag_;
	 ...
	 */
	public TcTpmDelegateSensitive(TcBlobData data)
	{
		super(data);
	}
	 ...
	 *      int)
	 */
	public TcTpmDelegateSensitive(TcBlobData data, int offset)
	{
		super(data, offset);
	}
	 ...
	 */
	public TcTpmDelegateSensitive(TcCompositeTypeDecoder composite)
	{
		super(composite);
	}
	...
	/*************************************************************************************************
	 * This method decodes the TPM_DELEGATE_SENSITIVE from the byte blob.
	 */
