...
public class TcTpmDelegateLabel extends TcCompositeTypeDecoder {
	 ...
	 *      int)
	 */
	public TcTpmDelegateLabel(TcBlobData data, int offset)
	{
		super(data, offset);
	}
	 ...
	 */
	public TcTpmDelegateLabel(TcCompositeTypeDecoder composite)
	{
		super(composite);
	}
	...
	/*************************************************************************************************
	 * This method decodes the TPM_DELEGATE_LABEL from the byte blob.
	 */
