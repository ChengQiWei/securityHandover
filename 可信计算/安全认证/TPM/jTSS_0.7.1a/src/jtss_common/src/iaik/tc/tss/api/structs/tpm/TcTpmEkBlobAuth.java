...
public class TcTpmEkBlobAuth extends TcCompositeTypeDecoder {
	protected int tag_;
	 ...
	 */
	public TcTpmEkBlobAuth(TcBlobData data)
	{
		super(data);
	}
	 ...
	 *      int)
	 */
	public TcTpmEkBlobAuth(TcBlobData data, int offset)
	{
		super(data, offset);
	}
	 ...
	 */
	public TcTpmEkBlobAuth(TcCompositeTypeDecoder composite)
	{
		super(composite);
	}
	...
	/*************************************************************************************************
	 * This method decodes the TPM_EK_BLOB_AUTH from the byte blob.
	 */
	protected void decode()
	{
		checkBoundaryPreconditions(2 + 20);
