...
public class TcTpmDelegateOwnerBlob extends TcCompositeTypeDecoder {
	protected int tag_;
	 ...
	 *      int)
	 */
	public TcTpmDelegateOwnerBlob(TcBlobData data, int offset)
	{
		super(data, offset);
	}
	...
	/*************************************************************************************************
	 * This method decodes the TPM_DELEGATE_OWNER_BLOB from the byte blob.
	 */
	protected void decode()
	{
		checkBoundaryPreconditions(2 + 48 + 20 + 4 + 4);
	...
	public TcBlobData getEncoded()
	{
		...
		retVal.append(TcBlobData.newBlobData(integrityDigest_.getEncoded()));
